...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Area of shape2d: " + shape.CalculateArea());

            Circle circle = new Circle(5);
            Console.WriteLine("Area of rectangle: " + circle.CalculateArea());
            Console.WriteLine("Aspect ratio of circle: " + circle.CalculateAspectRatio());
            Console.WriteLine("Is point [5, 5] contained in circle? " + circle.ContainsPoint(5, 5));
            Console.ReadKey();
        }
    }
}
